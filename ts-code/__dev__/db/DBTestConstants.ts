export enum DBSeed {
    ...
    ONE_NAME_TWO_ITEMS_OWNED = require("../../../resources/seeds/one-name-two-items-owned.json"),
    ONE_NAME_NUMBERED_DEFAULT = require("../../../resources/seeds/one-name-numbered-default.json"),
    ONE_NAME_TWO_ITEMS_NUMBERED_DEFAULT = require("../../../resources/seeds/one-name-two-items-numbered-default.json"),
    TWO_NAMES_NUMBERED_DEFAULT = require("../../../resources/seeds/two-names-numbered-default.json"),
...
export enum TestConstants {
    ...
    BATCH_ID_2 = "00000000-0000-0000-0000-000000000102",
    GROUP = "group1",
...
export enum TestTimestamps {
    ...
    START_DATE = 1645633800000, // 2022-02-23 08:30 PST
    END_DATE = 1645806600000, // 2022-02-25 08:30 PST
    START_DATE_2 = 1645727400000, // 2022-02-24 10:30 PST
    END_DATE_2 = 1645795800000, // 2022-02-25 05:30 PST
    START_DATE_3 = 1645536600000 // 2022-02-22 05:30 PST
}