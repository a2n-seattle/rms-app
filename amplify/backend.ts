...
const addItemFn = defineAddItemFunction(functionsStack, tables, backend.auth.resources.userPool)
...
const getItemFn = defineGetItemFunction(functionsStack, tables, backend.auth.resources.userPool)
