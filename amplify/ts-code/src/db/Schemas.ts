...
export interface MainSchema {
   ...
   location: string, // added loaction field
...
export interface ItemsSchema { // removed owner and batch fields
   id: string,
   name: string,
   friendlyName: string, // added friendly name field
   borrower: string,
   borrowTime: string, // added borrow time field
   returnTime: string, // added return time field
   history: string[],
   schedule: string[],
   notes: string
}
